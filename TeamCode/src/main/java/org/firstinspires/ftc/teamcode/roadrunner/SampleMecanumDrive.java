...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(6.1, 0, 0);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(6.2, 0, 0);

    public static double LATERAL_MULTIPLIER = 1.180055383830987;
    ...
    public void setPIDFCoefficients(DcMotor.RunMode runMode, PIDFCoefficients coefficients) {
        PIDFCoefficients compensatedCoefficients = new PIDFCoefficients(
                ...
                coefficients.f * (12.0 / batteryVoltageSensor.getVoltage())
        );
