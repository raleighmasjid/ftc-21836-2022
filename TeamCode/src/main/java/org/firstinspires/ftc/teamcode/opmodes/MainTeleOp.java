...
//      teleop control loop
        while (opModeIsActive()) {
            ...
            scorer.run(
                    Gamepad2.getTrigger(GamepadKeys.Trigger.RIGHT_TRIGGER) * Scorer.ANGLE_CONE_ARMS_DOWN,
                    Gamepad2.getTrigger(GamepadKeys.Trigger.LEFT_TRIGGER) * Scorer.ANGLE_CONE_ARMS_DOWN
            );
            drivetrain.run(
